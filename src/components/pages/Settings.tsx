...
import { Hotel, Flag, Users, Utensils, Car, Mail, CloudRain, Map, ListOrdered, Landmark, DollarSign, CalendarClock, Inbox, DollarSign as DollarIcon, Calculator, FileText, Truck, BookOpen, Image as ImageIcon, ClipboardList, Shield, Tag, Target, Wallet, Receipt, TrendingUp, Send } from 'lucide-react'
